...
if [ "$#" -lt "2" ]; then
    ...
    export NDK_TOOLCHAIN=${NDK}/toolchains/aarch64-linux-android-${COMPILER_VERSION}/prebuilt/linux-x86_64/bin
#    export CROSS_COMPILE=arm-linux-androideabi
    ...
    export CFLAGS="--sysroot=${SYSROOT} -mtune=cortex-a57.cortex-a53 -Dfopen64=fopen -Dfseeko64=fseeko -Dftello64=ftello -fPIE -pie"
